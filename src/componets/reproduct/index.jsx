...
import mp3 from "./imagine.mp3";
import mp32 from "./imagine1.mp3";
...
function Reproduct() {
  ...
  const [isMusic, setMusic] = useState(mp3);
    ...
    <footer className="Reproduct grid grid-cols-3 w-full rounded-md bg-slate-500/40 p-2">
      ...
      <div className="flex flex-col gap-2 justify-center items-center">
        ...
        <div className="h-3 w-full border rounded-md bg-transparent">
          <div
            className="h-full bg-white items-center transition-all duration-100 ease-in-out rounded-md"
